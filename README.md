...
After completing this, the script will select all unclassified sources that have been saved since the inputted date. The user can proceed to run SNID on unclassified transients, the process of which is the same as with the redshifts. Select the spectrum to use carefully, and check:
